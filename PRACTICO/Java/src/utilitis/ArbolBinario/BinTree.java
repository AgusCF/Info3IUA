public class BinTree {
    ...
    public BinTree(){this.root=null;}//Por defecto
    public BinTree(int element){
        root= new BinNode (element,null,null);
    }
    ...
    public void printPreOrder(){
        if(root!=null){root.PreOrder();}//Una forma rara de poner un if
    }
    public void printInOrder(){
        if(root!=null) root.InOrder();//Otra forma rara de poner un if (sin "{}")
    }
    public void printPostOrder(){if(root!=null) root.PostOrder();}//Forma mas rara...
